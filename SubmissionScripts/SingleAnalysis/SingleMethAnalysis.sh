...
matlab -nodesktop -singleCompThread -nosplash -nodisplay -c ${MATLICE} -r "disp('Job Running');tic;MethAnalysisForChr(${chr_num},'${phenoName}','totalProcessors',${totalProcessors},'processorNum',${processorNum},'species','${species}','ESIflag',${ESIflag},'MCflag',${MCflag});toc;"
