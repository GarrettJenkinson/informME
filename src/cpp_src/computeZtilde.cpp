 ...
 */
    ...
    for (int n = 0; n < N; n++) {
        mxSetCell(plhs[0],n,mxCreateString(logZ1tilde(n).toString().c_str()));
        mxSetCell(plhs[1],n,mxCreateString(logZ0tilde(n).toString().c_str()));

    }
    
    mxSetCell(plhs[2],0,mxCreateString(logZtilde.toString().c_str()));
