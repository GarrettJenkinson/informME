...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    for (int n = 0; n < N; n++) {
        mxSetCell(plhs[0],n,mxCreateString(logZ1(n).toString().c_str()));
        mxSetCell(plhs[1],n,mxCreateString(logZ0(n).toString().c_str()));

    }
    
    mxSetCell(plhs[2],0,mxCreateString(logZ.toString().c_str()));
