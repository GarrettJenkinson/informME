...
%
% Example usage: 
% DiffMethBlocks('coloncancer', 'colonnormal', 'Human')
%
% It takes as required Inputs:
%
% phenoName1
...
%
function DiffEntrBlocks( phenoName1, phenoName2, species ,varargin)
...
bedFileIDfiltered = fopen([trackPath 'DEB-'  phenoName1 '-VS-' phenoName2  '.bed'],'w'); %  ...
              %'_window' num2str(numRegInWindow) '_thresh' num2str(threshVal) '.bed'],'w');

hardCodedOptions = ['track  type=bedGraph visibility=full maxHeightPixels=100:15:11 autoScale=off viewLimits=-1.0:1.0 color=190,0,0 altColor=0,140,0 name=DEB-' phenoName1  '-VS-' phenoName2];%...
