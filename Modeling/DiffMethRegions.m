...
%
% Example usage: 
% DiffMethRegions( 'coloncancer', 'colonnormal', 'Human')
%
% Required inputs:
%
% phenoName1
...
%
function DiffMethRegions( phenoName1, phenoName2, species ,varargin)
...
%
bedFileName = [trackPath 'DMU-' phenoName1  '-VS-' phenoName2 '.bed'];
...
bedFileIDfiltered = fopen([trackPath 'DMR-'  phenoName1 '-VS-' phenoName2 '.bed'],'w');%...
            %'_window' num2str(numRegInWindow) '_thresh' num2str(threshVal) '.bed'],'w');

hardCodedOptions = ['track  type=bedGraph visibility=full maxHeightPixels=100:15:11 autoScale=off viewLimits=-1.0:1.0 color=190,0,0 altColor=0,140,0 name=DMR-' phenoName1 '-VS-' phenoName2];% ...
