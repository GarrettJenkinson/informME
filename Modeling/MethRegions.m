...
%
function MethRegions( phenoName, species ,varargin)
...
bedFileIDfiltered = fopen([trackPath 'MR-'  phenoName   '.bed'],'w');%...
            %'_window' num2str(numRegInWindow) '_thresh' num2str(threshVal) '.bed'],'w');

hardCodedOptions = ['track  type=bedGraph visibility=full maxHeightPixels=100:15:11 autoScale=off viewLimits=-1.0:1.0 color=190,0,0 altColor=0,140,0 name=MR-' phenoName];% ...
