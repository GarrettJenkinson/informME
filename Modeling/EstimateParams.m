...
try
    ...
    disp(['Error in MCS for phenotype ' phenoName ' at location: ' ...
        locationPathName ' with stack:']);
    getReport(ME)
    ME.stack.file
    ME.stack.name
    ME.stack.line
...
try
    ...
    logZ1=vpa(logZ1);logZ0=vpa(logZ0);logZ =vpa(logZ);
    [logZ1tilde,logZ0tilde,~] = computeZtilde(An,Cn); 
    logZ1tilde=vpa(logZ1tilde);logZ0tilde=vpa(logZ0tilde);
    ...
    disp(['Error in model estimation for phenotype ' phenoName ...
...
try 
    ...
    disp(['Error in creating structure for phenotype ' phenoName ...
        ' at location: ' locationPathName]);
end